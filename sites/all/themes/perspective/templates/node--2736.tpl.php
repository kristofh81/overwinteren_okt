        ...
        <div class="field-item even" property="content:encoded">
          ...
          <section class="price_box pb2col clearfix" style="margin-top: 0">
            <div class="pb_column pb_first clearfix">
              <div class="pb_head">Advertenteren per accommodatie</div>
              ...
              <div class="pb_row_x">Kortingsregeling bij meerdere advertenties </div>
              <div class="pb_price">€55,00 excl. btw per jaar</div>
              <div class="pb_footer"> <a href="http://www.overwinteren.nl/nl/content/meer-informatie-over-het-verkopen-van-een-accommodatie-op-abonnementsbasis"><img alt="" height="" src="/sites/default/files/images/button_meer-informatie_0.jpg" width="" style="display: block; visibility: visible; opacity: 1; margin-left:auto; margin-right:auto; "> </a> </div>
            </div>
            <div class="pb_column pb2col clearfix">
              <div class="pb_head">Bedrijfspresentatie</div>
              <div class="pb_row_y">Zakelijke verkoper</div>
              <div class="pb_row_x">Looptijd een jaar</div>
              <div class="pb_row_y">Beschrijving van uw bedrijf/diensten</div>
              ...
              <div class="pb_row_x">Kortingsregeling bij meerdere advertenties </div>
              <div class="pb_price">€55,00 excl. btw per jaar </div>
              <div class="pb_footer"><a href="http://www.overwinteren.nl/nl/content/meer-informatie-over-het-verkopen-van-accommodaties-met-een-bedrijfspresentatie"><img alt="" height="" src="/sites/default/files/images/button_meer-informatie_0.jpg" width="" style="display: block; visibility: visible; opacity: 1; margin-left:auto; margin-right:auto; "> </a> <div>
            </div>
          </section> 
